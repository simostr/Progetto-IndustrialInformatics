...
public class WriteThread extends Thread {
    ...
    public WriteThread(SessionChannel session, int namespace, int nodeId, UnsignedInteger attribute, Variant valueToWrite){
    ...
    public WriteThread(SessionChannel session,int namespace, String nodeId, UnsignedInteger attribute, Variant valueToWrite){
        this.valueToWrite=valueToWrite;
        this.namespace=namespace;
